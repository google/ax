...
const file_pkg_apis_v1alpha1_ax_proto_rawDesc = "" +
	...
	"\x06status\x18\x05 \x01(\v2\x17.ax.v1alpha1.TaskStatusR\x06status\"\xc9\x02\n" +
	"\bTaskSpec\x12\x14\n" +
	...
	"\x05debug\x18\n" +
	" \x01(\bR\x05debugJ\x04\b\x01\x10\x02J\x04\b\x02\x10\x03J\x04\b\t\x10\n" +
	"R\x04goalR\asuspendR\bpolicies\"2\n" +
	"\x06EnvVar\x12\x12\n" +
	...
	"\x04task\x18\x01 \x01(\v2\x11.ax.v1alpha1.TaskR\x04task\"@\n" +
	...
	"\x05tasks\x18\x01 \x03(\v2\x11.ax.v1alpha1.TaskR\x05tasks\"C\n" +
	...
	"\x02AX\x12?\n" +
	"\n" +
	"CreateTask\x12\x1e.ax.v1alpha1.CreateTaskRequest\x1a\x11.ax.v1alpha1.Task\x129\n" +
	"\aGetTask\x12\x1b.ax.v1alpha1.GetTaskRequest\x1a\x11.ax.v1alpha1.Task\x12J\n" +
	"\tListTasks\x12\x1d.ax.v1alpha1.ListTasksRequest\x1a\x1e.ax.v1alpha1.ListTasksResponse\x12M\n" +
	"\n" +
...
var file_pkg_apis_v1alpha1_ax_proto_depIdxs = []int32{
	...
	1,  // 34: ax.v1alpha1.CreateTaskRequest.task:type_name -> ax.v1alpha1.Task
	1,  // 35: ax.v1alpha1.ListTasksResponse.tasks:type_name -> ax.v1alpha1.Task
	...
	29, // 43: ax.v1alpha1.AX.CreateTask:input_type -> ax.v1alpha1.CreateTaskRequest
	30, // 44: ax.v1alpha1.AX.GetTask:input_type -> ax.v1alpha1.GetTaskRequest
	31, // 45: ax.v1alpha1.AX.ListTasks:input_type -> ax.v1alpha1.ListTasksRequest
	...
	1,  // 62: ax.v1alpha1.AX.CreateTask:output_type -> ax.v1alpha1.Task
	1,  // 63: ax.v1alpha1.AX.GetTask:output_type -> ax.v1alpha1.Task
	32, // 64: ax.v1alpha1.AX.ListTasks:output_type -> ax.v1alpha1.ListTasksResponse
