...
// TextDeltaContent represents an incremental text chunk in a stream. Unlike
// TextContent, it is not a complete text block and is intended for low-latency
// rendering while an execution is still producing output.
...
// ThoughtSummaryDeltaContent represents an incremental thought-summary chunk in a stream. Unlike
// ThoughtSummaryContent, it is not a complete thought-summary block and is intended for low-latency
// rendering while an execution is still producing output.
...
func (x *ThoughtSummaryDeltaContent) GetText() string {
	if x != nil {
		return x.Text
	}
	return ""
...
const file_proto_content_proto_rawDesc = "" +
	...
	"\bTYPE_WMV\x10\b\x12\r\n" +
	"\tTYPE_3GPP\x10\tB\r\n" +
	"\vdata_or_uriJ\x04\b\x03\x10\x04R\x04type\"&\n" +
	"\x10TextDeltaContent\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\"0\n" +
	"\x1aThoughtSummaryDeltaContent\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\"\xe5\x04\n" +
	"\aContent\x12.\n" +
...
var file_proto_content_proto_goTypes = []any{
	...
	(*TextDeltaContent)(nil),           // 19: ax.TextDeltaContent
	(*ThoughtSummaryDeltaContent)(nil), // 20: ax.ThoughtSummaryDeltaContent
...
var file_proto_content_proto_depIdxs = []int32{
	...
	22, // 6: ax.FunctionCallContent.arguments:type_name -> google.protobuf.Struct
	22, // 7: ax.FunctionResultContent.response:type_name -> google.protobuf.Struct
	...
	19, // 23: ax.Content.text_delta:type_name -> ax.TextDeltaContent
	20, // 24: ax.Content.thought_summary_delta:type_name -> ax.ThoughtSummaryDeltaContent
